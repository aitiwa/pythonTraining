print("caseStudy: 연산자 계산 - 중첩 조건문")
print('m3_1_ifEelifElseMultiTest_002.py\n')
...
print('        result = num1 / num2 ')
print('    else: ')
print('        print("연산자 선택이 잘못되었습니다.") ')
print('        print("다시 입력을 시도해 주세요.") ')
print()
print("3. 결과값->")
...
if op == 1:
    ...
    print("연산자 선택이 잘못되었습니다.")
    print("다시 입력을 시도해 주세요.")
